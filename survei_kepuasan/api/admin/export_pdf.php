...
<head>
    <meta charset="UTF-8">
    <title>Laporan Survei Kepuasan - RS</title>
    <style>
...
if ($avgRating >= 4.0) {
    $html .= '<p><strong>Kesimpulan:</strong> Secara keseluruhan, pasien merasa puas dengan pelayanan RS</p>';
...
$html .= '<div class="footer">
    <p>© 2025 RS - Sistem Survei Kepuasan Pasien</p>
